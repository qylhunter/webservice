package com.ws.soap.client.cxf;

import com.ws.soap.server.cxf.HelloCXFService;
import com.ws.soap.server.cxf.HiCXFService;
...
//        method5();
    ...
    private static void method4() throws MalformedURLException {
        ...
        QName qName = new QName("http://cxf.server.soap.ws.com/", "HiCXFService");
        Service service = Service.create(url, qName);
        //获得Hiservice的实现类对象，localPart参数是service name下的port name
        HiCXFService hiCXFServicePort = service.getPort(new QName("http://cxf.server.soap.ws.com/", "HiCXFServicePort"), HiCXFService.class);
